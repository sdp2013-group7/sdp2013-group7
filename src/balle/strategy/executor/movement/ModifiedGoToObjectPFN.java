...
public class ModifiedGoToObjectPFN implements MovementExecutor {
    ...
    private static final double WHEEL_RADIUS = Globals.ROBOT_WHEEL_DIAMETER * 100/3.33333333 ;
    ...
    public ModifiedGoToObjectPFN(double stopDistance, boolean slowDownCloseToTarget) {
     ...
     */
    public ModifiedGoToObjectPFN(double stopDistance) {
