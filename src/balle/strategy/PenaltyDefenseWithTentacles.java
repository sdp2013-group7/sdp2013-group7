...
public class PenaltyDefenseWithTentacles extends Game {

    private int SPEED;

    private static Logger LOG = Logger.getLogger(PenaltyDefenseWithTentacles.class);
    ...
    public PenaltyDefenseWithTentacles(int speed) {
        super();
        SPEED = speed;
	}

    public PenaltyDefenseWithTentacles() {
        this(200);
    }

	
    @FactoryMethod(designator = "Game (Penalty Defence) with tentacles", parameterNames = {})
	public static PenaltyDefenseWithTentacles gameFromPenaltyDefenceFactory()
	{
        return new PenaltyDefenseWithTentacles();
	}
